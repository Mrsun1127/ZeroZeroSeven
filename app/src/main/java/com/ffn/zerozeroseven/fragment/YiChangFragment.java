...
public class YiChangFragment extends BaseFragment implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    public static YiChangFragment newInstance(int id){
        Bundle args=new Bundle();
        args.putInt("id",id);
        YiChangFragment fragment=new YiChangFragment();
