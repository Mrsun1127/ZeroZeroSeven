...
public  class AppConfig {
    //单接口统一baseurl
//    public static final String BaseUrl="http://218.76.7.150:8080/xz-007-server/api/MobileServer/single";


    //外网请求地址
    public static final String BaseUrl="https://api.lingling7.com/lingling7-server/api/MobileServer/single";
//    public static final String BaseUrl="http://192.168.3.199:8001/lingling7-server/api/MobileServer/single";
    //分享地址
