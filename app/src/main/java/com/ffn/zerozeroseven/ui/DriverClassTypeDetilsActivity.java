        ...
        okGoUtils.setOnLoadSuccess(new OkGoUtils.OnLoadSuccess() {
            ...
            public void onSuccLoad(String response) {
                ...
                if (driverClassInfo.getCode() == 0) {
                    ...
                    String projectJson = driverClassInfo.getData().getDrivingClass().getClassesIntro();
                    String two = JsonUtil.getFieldValue(projectJson, "section2");
                    String three = JsonUtil.getFieldValue(projectJson, "section3");
                    tv_projectto.setText("科目二：" + two + "课时");
                    tv_projectthree.setText("科目三：" + three + "课时");
