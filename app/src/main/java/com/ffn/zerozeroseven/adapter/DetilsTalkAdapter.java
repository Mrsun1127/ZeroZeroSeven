...
public class DetilsTalkAdapter extends BaseRecyclerAdapter<BitisDetilsInfo.DataBean.MessagesBean> {
    public int clickPosition = 0;

    public DetilsTalkAdapter(Context context) {
        super(context);
    }

    @Override
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new DetilsTalkAdapter.MViewHolder(mInflater.inflate(R.layout.item_talk, parent, false));
    }

    @Override
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder holder, BitisDetilsInfo.DataBean.MessagesBean item, int position) {
