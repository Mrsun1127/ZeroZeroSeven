...
public class LevelPriceAdapter extends BaseRecyclerAdapter<String> {
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new LevelPriceAdapter.MViewHolder(mInflater.inflate(R.layout.item_level2, null));
    }
