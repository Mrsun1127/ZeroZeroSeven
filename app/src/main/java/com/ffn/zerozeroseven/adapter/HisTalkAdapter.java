...
public class HisTalkAdapter extends BaseRecyclerAdapter<BitisHistoryInfo.DataBean.PostsBean.MessagesBean> {
    public int clickPosition = 0;

    public HisTalkAdapter(Context context) {
        super(context);
    }

    @Override
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new HisTalkAdapter.MViewHolder(mInflater.inflate(R.layout.item_talk, parent, false));
    }
