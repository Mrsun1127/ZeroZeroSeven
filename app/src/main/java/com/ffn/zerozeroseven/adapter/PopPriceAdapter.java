...
public class PopPriceAdapter extends BaseRecyclerAdapter<String> {
    public PopPriceAdapter(Context context) {
        super(context);
    }
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new PopPriceAdapter.MViewHolder(mInflater.inflate(R.layout.item_level2, null));
    }
