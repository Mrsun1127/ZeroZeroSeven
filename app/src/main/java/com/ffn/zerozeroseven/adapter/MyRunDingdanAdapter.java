...
public class MyRunDingdanAdapter extends BaseRecyclerAdapter<MyRunDingDanInfo.DataBean.ListBean> {
    public MyRunDingdanAdapter(Context context) {
        super(context);
    }

    @Override
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new MyRunDingdanAdapter.MViewHolder(mInflater.inflate(R.layout.item_minerun, null));
    }

    @Override
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder holder, MyRunDingDanInfo.DataBean.ListBean info, int position) {
