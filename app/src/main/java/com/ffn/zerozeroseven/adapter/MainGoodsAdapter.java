...
public class MainGoodsAdapter extends BaseRecyclerAdapter<OftenShowInfo.DataBean.GoodsBean> {
    ...
    @Override
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder holder,final OftenShowInfo.DataBean.GoodsBean info,final int position) {
    ...
    private void AddCar(OftenShowInfo.DataBean.GoodsBean goodsInfo) {
        try {//
