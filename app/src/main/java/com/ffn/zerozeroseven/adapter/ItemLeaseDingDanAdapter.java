...
public class ItemLeaseDingDanAdapter extends BaseRecyclerAdapter<LeaseDingDanListINfo.DataBean.ListBean.OrderGoodsListBean> {
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new ItemLeaseDingDanAdapter.MViewHolder(mInflater.inflate(R.layout.item_dingdan_shop, null));
    }

    @Override
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder holder, LeaseDingDanListINfo.DataBean.ListBean.OrderGoodsListBean info, int position) {
