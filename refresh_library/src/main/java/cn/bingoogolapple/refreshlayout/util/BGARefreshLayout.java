...
public class BGARefreshLayout extends LinearLayout {
    ...
    public void beginLoadingMore() {
        if (!mIsLoadingMore && mLoadMoreFooterView != null && mDelegate != null && mDelegate.onLoadingMore(this)) {
            mIsLoadingMore = true;
    ...
    public interface BGARefreshLayoutDelegate {
         ...
         * 开始刷新
         */
        void onRefreshing(BGARefreshLayout refreshLayout);
         ...
         */
        boolean onLoadingMore(BGARefreshLayout refreshLayout);
    }
